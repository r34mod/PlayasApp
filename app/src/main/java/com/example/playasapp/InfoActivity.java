...
public class InfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void setupOnboardItems(){
            ...
            itemBoardPlaya.setTitle("Consulta tu chapuzon favorito");
            itemBoardPlaya.setDescription("Puedes visualizar las playas, piscinas, lagos... mejores de tu zona \uD83D\uDCAC");
            itemBoardPlaya.setImagen(R.drawable.beach);


            OnboardItem itemBoardPiscina = new OnboardItem();
            itemBoardPiscina.setTitle("Consulta tu chapuzon favorito");
            itemBoardPiscina.setDescription("Puedes visualizar las playas, piscinas, lagos... mejores de tu zona \uD83D\uDCAC");
            itemBoardPiscina.setImagen(R.drawable.ic_swimming_pool);


            OnboardItem itemBoardAll = new OnboardItem();
            itemBoardAll.setTitle("Consulta tu chapuzon favorito");
            itemBoardAll.setDescription("Puedes visualizar las playas, piscinas, lagos... mejores de tu zona \uD83D\uDCAC");
            itemBoardAll.setImagen(R.drawable.ic_home);


            OnboardItem itemBoardLast = new OnboardItem();
            itemBoardLast.setTitle("Consulta tu chapuzon favorito");
            itemBoardLast.setDescription("Puedes visualizar las playas, piscinas, lagos... mejores de tu zona \uD83D\uDCAC");
